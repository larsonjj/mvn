 ...
 */
static int
test_string_concat_append(void) {
 ...
 */
static int
test_string_starts_ends_with(void) {
 ...
 */
static int
test_string_case_conversion(void) {
...
test_string_substring(void) {
    ...
    // Invalid start index
    mvn_string_t* sub5 = mvn_string_substring(
        str, 20, 4); // Should return empty string or NULL? Let's assume empty
 ...
 */
int
run_string_tests(int* passed_tests, int* failed_tests, int* total_tests) {
    printf("\n===== STRING TESTS =====\n\n");
