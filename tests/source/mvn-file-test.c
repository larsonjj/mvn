 ...
 */
static int
test_get_application_directory(void) {
 ...
 */
static int
test_is_path_file_directory(void) {
...
test_get_file_mod_time(void) {
    ...
    if (file_exists) {
        ...
        TEST_ASSERT(time1 > 0, "mvn_get_file_mod_time returned non-positive for existing file");
 ...
 */
int
run_file_tests(int* passed_tests, int* failed_tests, int* total_tests) {
    printf("\n===== FILE TESTS =====\n\n");
